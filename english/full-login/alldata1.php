...
<html lang="en">
    ...
    <div class="mdl-layout mdl-js-layout">
       ...
       <ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-js-ripple-effect"
        ...
        <div>
        <h4 style="font-family:verdana; "> Search by date :</h4 >
...
echo " <tbody><tr><td>" . $row["full_name"]. "</td><td>" . $row["arrival_time"].  "</td><td>" . $row["checks"].  "</td></tr></tbody>" ;  
	...
	echo '<span style="color:rgb(218, 103, 11); font-size:160%; font-family:verdana; text-align:center;">Please enter the date  ... </span>';
}
?>
    </body>
</html>